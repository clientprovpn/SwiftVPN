...
extern int awgGetTunBatchSize(int handle);
...
JNIEXPORT jint JNICALL Java_org_amnezia_awg_GoBackend_awgGetTunBatchSize(JNIEnv *env, jclass c, jint handle)
{
	return awgGetTunBatchSize(handle);
}
