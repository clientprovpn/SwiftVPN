...
android {
    ...
    defaultConfig {
        ...
        externalNativeBuild {
            cmake {
                // arm64-v8a covers essentially every phone made since ~2015.
                // Add "armeabi-v7a" here (and in app/build.gradle.kts) if you
                // need to support older 32-bit devices; it roughly doubles
                // both build time and APK size.
